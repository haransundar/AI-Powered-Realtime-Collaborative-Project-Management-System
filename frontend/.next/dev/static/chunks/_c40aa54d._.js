...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "752895bd839bd5ca60ea7482d7f69e30872d2a385abbd2683360b9ca09214b3a") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "752895bd839bd5ca60ea7482d7f69e30872d2a385abbd2683360b9ca09214b3a";
    }
    let children;
    let props;
    let t1;
    ...
    let t5;
    if ($[1] !== t0) {
        ({ children, attribute: t1, defaultTheme: t2, enableSystem: t3, storageKey: t4, disableTransitionOnChange: t5, ...props } = t0);
        $[1] = t0;
        $[2] = children;
        $[3] = props;
        $[4] = t1;
    ...
    const attribute = t1 === undefined ? "class" : t1;
    const defaultTheme = t2 === undefined ? "light" : t2;
    const enableSystem = t3 === undefined ? false : t3;
    const storageKey = t4 === undefined ? "theme" : t4;
    const disableTransitionOnChange = t5 === undefined ? false : t5;
    let t6;
    if ($[9] !== attribute || $[10] !== children || $[11] !== defaultTheme || $[12] !== disableTransitionOnChange || $[13] !== enableSystem || $[14] !== props || $[15] !== storageKey) {
